...
(function($) {
	$.parser = {
		...
		plugins : [ "draggable", "droppable", "resizable", "pagination", "tooltip", "linkbutton", "menu", "menubutton", "splitbutton", "progressbar",
				"tree", "combobox", "combotree", "combogrid", "numberbox", "validatebox", "searchbox", "numberspinner", "timespinner", "calendar",
				"datebox", "datetimebox", "slider", "layout", "panel", "datagrid", "propertygrid", "treegrid", "tabs", "accordion", "window",
				"dialog" ],
		parse : function(_2) {
			var aa = [];
...
(function($) {
	...
	$.fn.panel.parseOptions = function(_21b) {
		var t = $(_21b);
		return $.extend({}, $.parser.parseOptions(_21b, [ "id", "width", "height", "left", "top", "title", "iconCls", "cls", "headerCls", "bodyCls",
				"tools", "href", {
					cache : "boolean",
					fit : "boolean",
					border : "boolean",
		...
		$(_249).window(
				$.extend({}, opts, {
					...
					onResize : function(_250, _251) {
						...
						_24a.panel("resize", {
							width : _252.width(),
							height : (_251 == "auto") ? "auto" : _252.height() - _252.children("div.dialog-toolbar")._outerHeight()
									- _252.children("div.dialog-button")._outerHeight()
						});
						if (opts.onResize) {
...
(function($) {
	...
	function _264(_265, _266, _267) {
		...
		if (_267) {
			...
			for ( var _268 in _267) {
				$("<a></a>").attr("href", "javascript:void(0)").text(_268).css("margin-left", 10).bind("click", eval(_267[_268])).appendTo(tb)
						.linkbutton();
			}
		}
		win.window({
	...
	$.messager = {
		...
		prompt : function(_270, msg, fn) {
			var _271 = "<div class=\"messager-icon messager-question\"></div>" + "<div>" + msg + "</div>" + "<br/>" + "<div style=\"clear:both;\"/>"
	...
	function _2cb(_2cc) {
		...
		if (opts.tools) {
			if (typeof opts.tools == "string") {
				...
				var _2ce = $("<div class=\"tabs-tool\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"height:100%\"><tr></tr></table></div>")
						.appendTo(_2cd);
				var tr = _2ce.find("tr");
				for (var i = 0; i < opts.tools.length; i++) {
					var td = $("<td></td>").appendTo(tr);
	...
	function _2dd(_2de) {
		...
		$(
				"<div class=\"tabs-header\">" + "<div class=\"tabs-scroller-left\"></div>" + "<div class=\"tabs-scroller-right\"></div>"
						+ "<div class=\"tabs-wrap\">" + "<ul class=\"tabs\"></ul>" + "</div>" + "</div>").prependTo(_2de);
...
(function($) {
	function _40f(_410, _411) {
		...
		var _414 = $("<iframe id=" + _413 + " name=" + _413 + "></iframe>").attr("src", window.ActiveXObject ? "javascript:false" : "about:blank")
				.css({
					position : "absolute",
					top : -1000,
					left : -1000
...
(function($) {
	...
	;
	function init(_44c) {
		$(_44c).addClass("calendar").html(
				"<div class=\"calendar-header\">" + "<div class=\"calendar-prevmonth\"></div>" + "<div class=\"calendar-nextmonth\"></div>"
						+ "<div class=\"calendar-prevyear\"></div>" + "<div class=\"calendar-nextyear\"></div>" + "<div class=\"calendar-title\">"
						+ "<span>Aprial 2010</span>" + "</div>" + "</div>" + "<div class=\"calendar-body\">" + "<div class=\"calendar-menu\">"
						+ "<div class=\"calendar-menu-year-inner\">" + "<span class=\"calendar-menu-prev\"></span>"
						+ "<span><input class=\"calendar-menu-year\" type=\"text\"></input></span>" + "<span class=\"calendar-menu-next\"></span>"
						+ "</div>" + "<div class=\"calendar-menu-month-inner\">" + "</div>" + "</div>" + "</div>");
	...
	function show(_464) {
		...
		for (var i = 0; i < _465.length; i++) {
			...
			for (var j = 0; j < week.length; j++) {
				var day = week[j];
				$("<td class=\"calendar-day calendar-other-month\"></td>").attr("abbr", day[0] + "," + day[1] + "," + day[2]).html(day[2]).appendTo(
						tr);
			}
		}
	...
	function init(_46f) {
		var _470 = $(
				"<span class=\"spinner\">" + "<span class=\"spinner-arrow\">" + "<span class=\"spinner-arrow-up\"></span>"
						+ "<span class=\"spinner-arrow-down\"></span>" + "</span>" + "</span>").insertAfter(_46f);
...
(function($) {
	...
	function _4bf(_4c0) {
		...
		if (opts.height != "auto") {
			var _4ca = _4c2 - _4c4.children("div.datagrid-header")._outerHeight() - _4c4.children("div.datagrid-footer")._outerHeight()
	...
	function _4e0(_4e1, _4e2) {
		...
		var _4e6 = $(
				"<div class=\"datagrid-wrap\">" + "<div class=\"datagrid-view\">" + "<div class=\"datagrid-view1\">"
						...
						+ "<div class=\"datagrid-footer-inner\"></div>" + "</div>" + "</div>" + "</div>" + "</div>").insertAfter(_4e1);
		_4e6.panel({
			doSize : false
		});
						...
						if (type == "footer") {
							...
							if (type == "selected") {
								...
								if (type == "highlight") {
									...
									if (type == "checked") {
										return (_69c == 1 ? dc.body1 : dc.body2)
					...
					$.fn.datagrid.defaults.view,
					{
						render : function(_6ce, _6cf, _6d0) {
							...
							for (var i = 0; i < _6d5.length; i++) {
								var _6d6 = _6d5[i];
								_6d3.push("<div class=\"datagrid-group\" group-index=" + i
...
(function($) {
	...
	function _715(_716, _717) {
		...
		function _71a(tr, _71b) {
			$("<tr class=\"treegrid-tr-tree\">" + "<td style=\"border:0px\" colspan=\"" + _71b + "\">" + "<div></div>" + "</td>" + "</tr>")
					.insertAfter(tr);
		}
		;
	}
			...
			function _782(_783, _784, _785) {
				...
				for (var i = 0; i < _785.length; i++) {
					...
					if (row.children && row.children.length) {
						...
						_786.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan=" + (_77e.length + (opts.rownumbers ? 1 : 0))
								+ "><div style=\"display:" + v + "\">");
						_786 = _786.concat(tt);
						_786.push("</div></td></tr>");
					}
	...
	function init(_7c5) {
		...
		var span = $(
				"<span class=\"combo\">" + "<input type=\"text\" class=\"combo-text\" autocomplete=\"off\">"
						+ "<span><span class=\"combo-arrow\"></span></span>" + "<input type=\"hidden\" class=\"combo-value\">" + "</span>")
				.insertAfter(_7c5);
...
(function($) {
	...
	$.fn.combobox.parseOptions = function(_84a) {
		var t = $(_84a);
		return $.extend({}, $.fn.combo.parseOptions(_84a), $.parser.parseOptions(_84a, [ "valueField", "textField", "groupField", "mode", "method",
				"url" ]));
	};
...
(function($) {
	function _856(_857) {
		...
		tree.tree($.extend({}, opts, {
			...
			onClick : function(node) {
				_85c(_857);
				var opts = $(_857).combotree("options");
...
(function($) {
	...
	$.fn.combogrid.parseOptions = function(_890) {
		var t = $(_890);
		return $.extend({}, $.fn.combo.parseOptions(_890), $.fn.datagrid.parseOptions(_890), $.parser.parseOptions(_890, [ "idField", "textField",
				"mode" ]));
	};
	...
	function init(_8ce) {
		var _8cf = $(
				"<div class=\"slider\">" + "<div class=\"slider-inner\">" + "<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"
						...
						+ "<input type=\"hidden\" class=\"slider-value\">" + "</div>").insertAfter(_8ce);

...
//var agencyIdtitle;
		...
		*/
		...
		$.exportConfirmationFile=function(){
			...
			*/
			$.getToPost('${ctx}/splitfee/splitfee.do?method=exportConfirmationFile',{
				agencyIdf : agencyIdf,
				datestart : datestart,
				dateend : dateend
		   });
		...
		$.splitFeeView=function(){
			...
			$('#splitFee').datagrid({
						url : '${ctx}/splitfee/splitfee.do?method=getChildSplitFee',
						queryParams : {								
							/*
							yearmonth:yearmonth,
							agencyIdf:agencyId,
		...
		$.splitFeeDetail = function(index){
			...
			$('#splitFeeDetail').datagrid(
					{
						url : '${ctx}/splitfee/splitfee.do?method=splitFeeDetail',
						queryParams : {								
							yearmonth:yearmonth,
							agencyId:agencyId,
							dealTypeId:dealTypeId
